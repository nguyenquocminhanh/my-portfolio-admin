            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="myForm" method="POST" action="{{ route('blog.page.update') }}" enctype="multipart/form-data">
                            @csrf

                            <div class="row mb-3">
                                <label for="example-text-input" class="col-sm-2 col-form-label">Description</label>
                                <div class="form-group col-sm-10">
                                    <input class="form-control" type="text" name="description" value="{{ $blog ? $blog->description : '' }}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="form-group col-sm-10">
                                    ...
                                    <div class="col-10 col-lg-12">
                                        <img id="showImage" class="rounded avatar-lg" src="{{ $blog->cover_image ? $blog->cover_image : url('upload/no_image.jpg') }}"  class="card-img-top">
                                    </div>
                                    @else
                                    <div class="col-10 col-lg-12">
