                        ...
                        <form id="myForm" method="POST" action="{{ route('project.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group col-10 col-lg-12">
                                        <input class="form-control" type="text" name="technologies" value="{{old('technologies')}}" data-role="tagsinput">
                                        @error('technologies')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group col-10 col-lg-12">
                                        <input class="form-control" type="text" name="project_link" value="{{old('project_link')}}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group col-10 col-lg-12">
                                        <input class="form-control" type="text" name="frontend_link" value="{{old('frontend_link')}}">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group col-10 col-lg-12">
                                        <input class="form-control" type="text" name="backend_link" value="{{old('backend_link')}}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="col-10 col-lg-12">
                                                <img id="showThumbnailImage" class="rounded avatar-lg" src="{{ url('upload/no_image.jpg') }}"  class="card-img-top">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group col-10 col-lg-12">
                                        <input class="form-control" type="text" name="thumbnail_caption" value="{{old('thumbnail_caption')}}">
                                    </div>
                                </div>
                            </div>
                            <br>
                                ...
                                <div class="col-lg-6">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <label for="example-text-input" class="col-sm-12 col-form-label"></label>
                                            <div class="col-10 col-lg-12">
                                                <img id="showWallpaperImage" class="rounded avatar-lg" src="{{ url('upload/no_image.jpg') }}" class="card-img-top">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <label for="example-text-input" class="col-sm-12 col-form-label"></label>
                                            <div class="col-10 col-lg-12">
                                                <img id="showAuthorImage" class="rounded avatar-lg" src="{{ url('upload/no_image.jpg') }}" class="card-img-top">
                                            </div>
                                        </div>     
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <label for="example-text-input" class="col-sm-12 col-form-label"></label>
                                            <div class="col-10 col-lg-12">
                                                <img id="showDesignImage" class="rounded avatar-lg" src="{{ url('upload/no_image.jpg') }}" class="card-img-top">
                                            </div>
                                        </div>     
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <div class="form-group col-10 col-lg-12">
                                                <input class="form-control" type="text" name="demo_video" value="{{ old('demo_video') }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <br>
                            <center>
                                <input type="submit" class="btn btn-info waves-effect waves-light" value="Add New Project">
                            </center>
                        </form>
