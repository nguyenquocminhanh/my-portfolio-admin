    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card pb-5">
                    <div class="card-body">
                        <a href="{{ route('project.category.all') }}" class="btn btn-dark btn-rounded waves-effect waves-light" style="float: right;"><i class="fas fa-list"> Back</i></a>

                        <h4 class="card-title">Edit Project Category</h4>
                        <br>
                        <br>
                       
                        <form id="myForm" method="POST" action="{{ route('project.category.update') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <center>
                                <input type="submit" class="btn btn-info waves-effect waves-light" value="Update Project Category">
                            </center>
                        </form>
