                        ...
                        <form id="myForm" method="POST" action="{{ route('education.update') }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="form-group col-sm-10">
                                    <input class="form-control" type="text" name="school" value="{{ $education->school }}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="form-group col-sm-10">
                                    <input class="form-control" type="text" name="description" value="{{ $education->description }}">
                                </div>
                            </div>
                            ...
                            <center>
                                <input type="submit" class="btn btn-info waves-effect waves-light" value="Update Education">
                            </center>
                        </form>
