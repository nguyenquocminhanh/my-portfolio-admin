            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title">Edit Programming Language</h4>
                        <br>
                        <br>
                       
                        <form id="myForm" method="POST" action="{{ route('programming_language.update') }}">
                            @csrf
                            ...
                            <center>
                                <input type="submit" class="btn btn-info waves-effect waves-light" value="Update Programming Language">
                            </center>
                        </form>
