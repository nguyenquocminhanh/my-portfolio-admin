                    ...
                    <div class="card-body">
                        ...
                        <form id="myForm" method="POST" action="{{ route('experience.store') }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="form-group col-sm-10">
                                    <textarea class="form-control" type="text" rows="5" name="description">{{old('description')}}</textarea>
                                </div>
                            </div>
                            ...
                            <center>
                                <input type="submit" class="btn btn-info waves-effect waves-light" value="Add New Experience">
                            </center>
                        </form>
